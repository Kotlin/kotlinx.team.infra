...
private fun Flags.toVisibilityString(): String? = VISIBILITY_FLAGS_MAP.entries.firstOrNull { (modifier) -> modifier(this) }?.value
...
fun KotlinClassMetadata.toClassVisibility(className: String): ClassVisibility? {
    ...
    return ClassVisibility(className, flags, members.associateBy { it.member }, _facadeClassName)
}
